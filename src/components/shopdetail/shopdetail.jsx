...
const Shopdetail = ({ shops, addOrder }) => {
  const { id } = useParams();
  const { name, desc, ShopImg, location, product } = shops[id];
  return (
              ...
              <div class="items-center lg:flex">
                <div class="lg:w-1/2">
                  ...
                  <p class="mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md">
                    ...
                    Illum in sed non alias, fugiat, commodi nemo ut fugit
                    corrupti dolorem sequi ex veniam consequuntur id, maiores
            ...
            <div class="container px-6 py-8 mx-auto">
              <div class="items-center lg:flex">
                <div class="lg:w-1/2">
                  ...
                  <p class="mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md">
                    <p>Hours: Tuesday 8:30am–8pm</p>
                    <p> Wednesday 8:30am–8pm</p>
